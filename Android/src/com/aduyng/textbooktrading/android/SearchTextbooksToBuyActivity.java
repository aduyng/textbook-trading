...
public class SearchTextbooksToBuyActivity extends ListActivity implements
		OnScrollListener, OnClickListener {

	public static final int VIEW_REQUEST_CODE = 1000;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		refresh();
		getListView().setOnScrollListener(SearchTextbooksToBuyActivity.this);
	...
	private class TextbooksAdapter extends BaseAdapter {
		...
		LayoutInflater inflater = (LayoutInflater) SearchTextbooksToBuyActivity.this
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			((TextView) rowView.findViewById(R.id.timestampTextView))
					.setText(android.text.format.DateUtils
							.getRelativeDateTimeString(
									SearchTextbooksToBuyActivity.this,
			...
			rowView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent data = new Intent(SearchTextbooksToBuyActivity.this,
							ViewASellingTextbookActivity.class);
					data.putExtra(ViewASellingTextbookActivity.TEXTBOOK_ID,
							record.getId());
					SearchTextbooksToBuyActivity.this.startActivityForResult(data,
							SearchTextbooksToBuyActivity.VIEW_REQUEST_CODE);
	...
	private class DownloadTextbookImageAsyncTask extends
		...
		protected Bitmap doInBackground(RowViewDownloadImage... params) {
			...
			try {
				...
				byte[] b = new RestClient(SearchTextbooksToBuyActivity.this)
	...
	private class GettingMySellingTextbooksAsyncTask extends
		...
		protected List<Textbook> doInBackground(Void... params) {
			// isGettingData = true;
			try {
				return new TextbookModel(SearchTextbooksToBuyActivity.this)
						.fetch(null,
				...
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						new AlertDialog.Builder(SearchTextbooksToBuyActivity.this)
								.setTitle(
